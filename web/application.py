    ...
    def wsgifunc(self, *middleware):
        ...
        def peep(iterator):
            ...
            try:
                ...
                firstchunk = ''
            print "###fisrtchunk",firstchunk
            return itertools.chain([firstchunk], iterator)    
                                
        def is_generator(x): return x and hasattr(x, 'next')
        
        def wsgi(env, start_resp):
            print "in applicatiion fun wsgi env",env
            print "in applicatiion fun wsgi start_resp",start_resp
            ...
            try:
                ...
                result = [e.data]
            print "###before safe result is",result
            result = web.safestr(iter(result))

            print "###after safe result is",result
